...
db.run("CREATE TABLE logs (time TEXT, username TEXT, user_id TEXT, staff_username TEXT, staff_id TEXT, reason TEXT, log_message_id TEXT, action TEXT)")
...
db.run("CREATE TABLE users (id TEXT PRIMARY KEY, username TEXT, points INTEGER, warnings INTEGER, kicks INTEGER, bans INTEGER)")
