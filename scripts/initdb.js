...
db.run("CREATE TABLE logs (id INTEGER, legacy INTEGER, time TEXT, username TEXT, user_id TEXT, staff_username TEXT, staff_id TEXT, reason TEXT, log_message_id TEXT, action TEXT, user_log_num)")
db.run("CREATE TABLE evidence (id INTEGER, user_log_num INTEGER, reason TEXT, time TEXT, evidence_url TEXT, user TEXT)")
db.run("CREATE TABLE comments (log_id INTEGER, time TEXT, staff TEXT, staff_id TEXT, content TEXT)")
db.run("CREATE TABLE users (id TEXT PRIMARY KEY, username TEXT, logs INTEGER, points INTEGER, warnings INTEGER, kicks INTEGER, bans INTEGER, legacy_imported INTEGER)")
