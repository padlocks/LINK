...
const Moderation = require('../../src/structures/Game')
const data = require('./game-logs.json')
...
async function start() {
    var config = require('../../src/structures/Settings').load()
    for (messages in data[0]) {
        ...
        messages.map(msg => {
            ...
            //console.log(x)
            Moderation.addLogLegacy(x, 'GAME', datetime, username, id, staff, staffId, details, msg['id'], action)
